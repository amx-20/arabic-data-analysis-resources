...
>الشركات بتجمع كميات كبيرة من البيانات وبتحللها عشان تاخد قرارات استراتيجية في مختلف العمليات. محلل البيانات بيجمع البيانات، وينضفها، ويفسرها، عشان يجاوب على سؤال معين أو يحل مشكلة معينة.
